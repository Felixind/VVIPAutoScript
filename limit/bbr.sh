...
echo -e "Installing TCP BBR Mod BY NUSANTARA TUNNELING"
echo -e "Silahkan Menunggu Penginstalan BBR Akan Dimulai . . ."
sleep 5
clear
...
Install_BBR(){
echo -e "\e[32;1m================================\e[0m"
echo -e "\e[32;1mMenginstall TCP BBR...\e[0m"
if [ -n "$(lsmod | grep bbr)" ];then
echo -e "\e[0;32mBerhasil Menginstall TCP BBR.\e[0m"
echo -e "\e[32;1m================================\e[0m"
return 1
fi
echo -e "\e[0;32mMemulai Untuk Install BBR...\e[0m"
modprobe tcp_bbr
...
if [ -n "$(sysctl net.ipv4.tcp_available_congestion_control | grep bbr)" ] && [ -n "$(sysctl net.ipv4.tcp_congestion_control | grep bbr)" ] && [ -n "$(lsmod | grep "tcp_bbr")" ];then
	echo -e "\e[0;32mTCP BBR Install Berhasil!\e[0m"
else
	echo -e "\e[1;31mGagal Untuk Install BBR!\e[0m"
fi
echo -e "\e[32;1m================================\e[0m"
}
...
echo -e '\e[32;1m============================================================\e[0m'
echo -e '\e[0;32m                  Installasi Berhasil!!!                     \e[0m'
echo -e '\e[32;1m============================================================\e[0m'
sleep 3
#fi
